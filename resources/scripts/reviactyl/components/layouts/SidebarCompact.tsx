...
const SidebarContainer = styled.div<{ $isOpen: boolean }>`
    ${tw`w-[225px] 2xl:w-64 self-start border border-gray-800 bg-gray-900 text-white flex flex-col z-40 transition-transform duration-300 ease-in-out`};
...
export const SidebarCompact = React.forwardRef<HTMLDivElement, SidebarProps>(({ children, isOpen = false }, ref) => {
    return (
