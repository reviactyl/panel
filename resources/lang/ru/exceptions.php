...
return [
    ...
    'node' => [
        'servers_attached' => 'Для удаления узла к ней не должно быть привязано ни одного сервера.',
    ...
    'locations' => [
        'has_nodes' => 'Невозможно удалить локацию, к которой привязаны активные узлы.',
    ],
    'users' => [
        'node_revocation_failed' => 'Не удалось отозвать ключи на <a href=":link"> Узле #:node</a>. :error',
    ],
    'deployment' => [
        'no_viable_nodes' => 'Не найдено узла, удовлетворяющих требованиям для автоматического развёртывания.',
