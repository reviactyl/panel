...
return [
    ...
    'subuser_preview' => [
        'start_blocked' => 'Vous ne pouvez pas lancer un autre aperçu tant que le mode aperçu est activé.',
        'owner_only' => 'Seul le propriétaire du serveur peut prévisualiser un sous-utilisateur.',
        'session_unavailable' => 'Cette séance de prévisualisation n\'est plus disponible.',
        'session_expired' => 'La durée de validité de cette session de prévisualisation a expiré.',
        'concurrent_start' => 'Une séance de prévisualisation est déjà en cours.',
        'account_unavailable' => 'Les informations relatives au compte ne sont pas disponibles pendant la phase de prévisualisation du sous-utilisateur.',
        'categories_unavailable' => 'Les catégories de serveurs personnels ne sont pas disponibles pendant la phase de prévisualisation des sous-utilisateurs.',
        'permission_denied' => 'Vous n\'êtes pas autorisé(e) à effectuer cette action dans l\'aperçu.',
        'resource_unavailable' => 'Cette ressource n\'est pas disponible pendant la phase de prévisualisation des sous-utilisateurs.',
        'live_connection_unavailable' => 'Cette connexion en direct n\'est pas disponible pendant la phase de prévisualisation des sous-utilisateurs.',
        'file_not_found' => 'Le fichier demandé n\'existe pas dans cet aperçu.',
        'file_too_large' => 'Ce fichier est trop volumineux pour être affiché dans l\'aperçu.',
        'state_too_large' => 'Cet aperçu a atteint sa limite de stockage.',
        'unsafe_pull_url' => 'Seules les URL HTTPS sécurisées peuvent être intégrées à l\'aperçu.',
        'action_unavailable' => 'Cette action n\'est pas disponible pendant l\'aperçu du sous-utilisateur.',
        'database_limit' => 'Ce serveur a atteint la limite de sa base de données.',
        'database_host_unavailable' => 'Aucun hôte de base de données n\'est disponible pour ce serveur.',
        'task_limit' => 'Ce planning a atteint sa limite de tâches.',
        'allocation_limit' => 'Ce serveur a atteint sa limite d\'allocation.',
        'allocation_unavailable' => 'Aucune allocation supplémentaire n\'est disponible pour ce serveur.',
        'primary_allocation' => 'L\'affectation principale ne peut pas être supprimée.',
        'backup_limit' => 'Ce serveur a atteint sa limite de sauvegarde.',
        'locked_backup' => 'Une sauvegarde verrouillée ne peut pas être supprimée.',
        'variable_unavailable' => 'La variable d\'environnement n\'est pas disponible ou est en lecture seule.',
        'docker_image_unavailable' => 'L\'image Docker sélectionnée n\'est pas disponible pour ce serveur.',
    ],
    'databases' => [
