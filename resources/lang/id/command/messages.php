...
return [
    ...
    'info' => [
        'titles' => [
            ...
            'email' => 'Konfigurasi Surel',
        ],
        'fields' => [
            'panel_version' => 'Versi Panel',
            'latest_version' => 'Versi Terbaru',
            'up_to_date' => 'Terkini',
            'unique_identifier' => 'Pengidentifikasi Unik',
            'environment' => 'Lingkungan',
            'debug_mode' => 'Modus Debug',
            'installation_url' => 'URL Instalasi',
            'installation_directory' => 'Direktori Instalasi',
            'timezone' => 'Zona waktu',
            'cache_driver' => 'Pengemudi Tembolok',
            'queue_driver' => 'Pengemudi Antrian',
            'session_driver' => 'Pengemudi Sesi',
            'filesystem_driver' => 'Driver Sistem File',
            'proxies' => 'Proksi',
            'driver' => 'Pengemudi',
            'host' => 'Tuan rumah',
            'port' => 'Pelabuhan',
