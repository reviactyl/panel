...
return [
    ...
    'info' => [
        ...
        'public-status-page' => 'Página de status público',
    ],
    'rename' => [
    ...
    'reinstall' => [
        ...
        'disabled' => 'A reinstalação não está disponível porque este servidor está configurado para ignorar o script de instalação do seu egg.',
    ],
];
