...
return [
    ...
    'passkeys' => [
        'description' => 'Gerencie chaves de acesso para login sem senha, utilizando biometria ou chaves de segurança de hardware.',
        'unsupported' => 'Seu navegador não é compatível com chaves de acesso.',
        'empty' => 'Não há senhas de acesso registradas nesta conta.',
        'name' => 'Nome da senha',
        'name-placeholder' => 'por exemplo, notebook',
        'password' => 'Senha da conta',
        'register' => 'Registrar senha de acesso',
        'remove' => 'Remover',
        'created' => 'Criado',
        'updated' => 'Última utilização',
        'delete-confirm' => 'Deseja remover essa senha de acesso da sua conta?',
        'delete-password-prompt' => 'Digite a senha da sua conta para remover essa senha de acesso.',
        'password-required' => 'Você precisa inserir a senha da sua conta para continuar.',
    ],
    'api' => [
        'title' => 'API da Conta',
