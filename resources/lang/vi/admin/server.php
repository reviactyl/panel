...
return [
    ...
    'exceptions' => [
        ...
        'skipping_install_script' => 'Máy chủ này được cấu hình để bỏ qua tập lệnh cài đặt của egg. Không thể tiến hành cài đặt lại cho đến khi thiết lập đó được tắt đi.',
    ],
