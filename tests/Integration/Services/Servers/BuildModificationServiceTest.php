...
class BuildModificationServiceTest extends IntegrationTestCase
{
     ...
     */
    public function test_allocations_can_be_modified_for_the_server()
    {
     ...
     */
    public function test_exception_is_thrown_if_removing_the_default_allocation()
    {
        $server = $this->createServerModel();
        /** @var Allocation[] $allocations */
     ...
     */
    public function test_no_exception_is_thrown_if_only_removing_allocation()
    {
        $server = $this->createServerModel();
     ...
     */
    public function test_allocation_in_both_add_and_remove_is_added()
    {
        $server = $this->createServerModel();
        /** @var Allocation $allocation */
     ...
     */
    public function test_using_same_allocation_id_multiple_times_does_not_error()
    {
        $server = $this->createServerModel();
        /** @var Allocation $allocation */
        $allocation = Allocation::factory()->create(['node_id' => $server->node_id, 'server_id' => $server->id]);
     ...
     */
    public function test_that_updates_are_rolled_back_if_exception_is_encountered()
    {
        $server = $this->createServerModel();
        /** @var Allocation $allocation */
        $allocation = Allocation::factory()->create(['node_id' => $server->node_id]);
